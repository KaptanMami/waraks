  ...
  if (emojis.length > 1) {
    ...
    message.channel
      ...
      .then(async function(sentEmbed) {
        ...
        reactions.on("end", () =>
          sentEmbed.edit(
            "**Etkileşimli komut sona erdi: 5 dakika geçti** "
          )
        );
      })
      .catch(() => {
        message
          .reply("Bu embed'i göndermeye çalışırken bir hata oluştu.")
          .catch(() => {
            message.author
...
//nasıl oldu komut /efsane :D /ben yaptm çünki asdsa